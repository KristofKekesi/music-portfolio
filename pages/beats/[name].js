            ...
            <main className="bg-cover bg-fixed min-h-screen flex flex-col gap-8 pt-24"
                ...
                <div className="px-8">
                    <div className="flex gap-8 justify-between">
                            <div className="pt-8">
                                <h2 className="font-spaceGrotesk text-2xl px-4">About the Beat</h2>
                                ...
                                {beat.links.youtube == undefined ? 
                                    ...
                                    <div className="flex flex-col p-6 md:p-8 w-full">
                                        <div className="flex flex-col">
                                            <p className="font-spaceGrotesk pt-0 text-sm opacity-60">{ beat.release }</p>
                                            <div className="flex gap-4 items-baseline">
                                                <p className="font-spaceGrotesk text-3xl">{ beat.name }</p>
                                                <p className="font-spaceGrotesk text-base opacity-50">{ secondsToDisplay(beat.length) }</p>
                                            </div>
                                            <div className="flex flex-wrap gap-x-8 pt-4 whitespace-nowrap">
                                                <p className="font-spaceGrotesk"><span className="text-2xl">{ beat.bpm.join(", ") }</span><span className="opacity-60">bpm</span></p>
                                                <p className="font-spaceGrotesk"><span className="text-2xl">{ letter }</span><span className="opacity-60"> { key }</span></p>
                                            </div>
                                            <p className="font-spaceGrotesk opacity-60 text-justify">{ beat.description }</p>
                        ...
                        {(beat.links.youtube != undefined) ?
                            <div className="pt-8">
                                <h2 className="font-spaceGrotesk text-2xl px-4">Stream it on youtube</h2>
                    ...
                    <div className="pt-8">
                        <h2 className="font-spaceGrotesk text-2xl px-4">License it on beatstars</h2>
                ...
                <div className="px-8">
                    <h2 className="font-spaceGrotesk text-2xl px-4">More like this</h2>
