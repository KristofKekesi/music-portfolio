    ...
    return (
        <div className="px-8 pt-1 pb-5 flex justify-between items-center">
            <div className="flex gap-x-4 items-center">
                { props.beat.coverURL != undefined ? <Image src={ props.beat.coverURL } className="rounded-xl" width={64} height={64} /> : <div className=" bg-white/10 aspect-square rounded-xl w-16 r-16" /> }
