    ...
    return (
		<>
			...
			<nav id="header" className={"flex flex-row items-top justify-between w-full p-8 pt-4 pb-4 gap-8 fixed top-0 left-0 z-40 " + props.className}>
				...
				<div id="search-bar" className={space_grotesk.className + " flex justify-center right-0 items-center pr-4 rounded-full border border-white h-8 bg-white/10 backdrop-blur-3xl transition-all z-50"}>
